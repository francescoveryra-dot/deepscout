...
export const MESSAGES: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "demo.runId": "Run ID",
    "demo.notice.title": "Explore a real completed research run",
    "demo.notice.body":
      "This is genuine Deep Scout output. Browse the plan, sources, evidence, and report without consuming API credits. Sign in to run research with your own credentials.",
  ...
  it: {
    ...
    "demo.notice.title": "Esplora una ricerca reale già completata",
    "demo.notice.body":
      "Questa è una ricerca reale già completata da Deep Scout. Puoi esplorare piano, fonti, evidenze e report senza consumare API. Accedi per avviare una ricerca con le tue credenziali.",
