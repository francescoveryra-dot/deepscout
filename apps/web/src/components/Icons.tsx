...
export function IconHome(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden {...props}>
...
export function IconSources(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden {...props}>
      <path d="M4 5h12a3 3 0 0 1 3 3v11H8a4 4 0 0 1-4-4z" />
      <path d="M8 5v14" />
    </svg>
  );
}
...
export function IconClaims(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden {...props}>
...
export function IconReport(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden {...props}>
      ...
      <path d="M15 3v5h5M9 13h8M9 17h6" />
    </svg>
  );
}
...
export function IconBolt(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden {...props}>
...
export function IconCheck(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2.2" aria-hidden {...props}>
