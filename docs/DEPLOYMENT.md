...
- `ghcr.io/francescoveryra-dot/deepscout-api:0.1.1` for the migration, API, and worker roles;
- `ghcr.io/francescoveryra-dot/deepscout-web:0.1.1` for the Next.js frontend.
