...
def test_default_embedding_models_present_for_supported_providers() -> None:
    assert ProviderKind.GOOGLE in DEFAULT_EMBEDDING_MODELS
    assert ProviderKind.OPENAI in DEFAULT_EMBEDDING_MODELS
    assert ProviderKind.ANTHROPIC not in DEFAULT_EMBEDDING_MODELS
