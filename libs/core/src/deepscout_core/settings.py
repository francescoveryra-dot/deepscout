...
class Settings(BaseSettings):
    ...
    research_max_coverage_rounds: int = Field(default=3, alias="RESEARCH_MAX_COVERAGE_ROUNDS")
    research_max_gap_queries_per_round: int = Field(
        default=6, alias="RESEARCH_MAX_GAP_QUERIES_PER_ROUND"
    )
    research_max_report_rewrites: int = Field(default=3, alias="RESEARCH_MAX_REPORT_REWRITES")
