...
AUTHORITATIVE_EVENT_TYPES = frozenset(
    {
        ...
        ResearchEventType.RUN_BUDGET_EXHAUSTED,
...
EVENT_LAYER: dict[ResearchEventType, StreamLayer] = {
    ...
    ResearchEventType.RUN_BUDGET_EXHAUSTED: StreamLayer.ORCHESTRATOR,
    ...
    ResearchEventType.SOURCE_FETCH_FAILED: StreamLayer.TOOL,
